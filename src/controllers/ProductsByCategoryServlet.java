 ...
 * @version 1.0
 */
@WebServlet(name = "ProductsByCategoryServlet")
public class ProductsByCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter writer = response.getWriter()) {
            ...
            List<ProductDto> productDtoList = productService.getAllProductsByCategory(categoryId);
            ...
            writer.println("<h3><table > <tr>\n" +
                    ...
                    "  <th>      Price  </th>\n" +
                    "</tr></table><h3>");
            writer.println("<h3>" + productDtoList + "</h3>");
